...
在PHP中 , 值对象是获得某种类型的不变性的一种很好的方式 . 虽然它没有给你带来更多的好处 , 特别是那些与绩效相关的 , 但是大部分的认知负担都被移除了 . 要了解更多 , 可以查看这个网站 , http://www.phpvalueobjects.info/ , 但是网站好像已经无法打开 , 关注了Twitter , 其中可以发现一些很好的内容 . 
